window.addEventListener('DOMContentLoaded', () => {
	...
	let btnOnl = document.getElementById("nextPic");
	let numCaun = document.getElementById("current")
	let numCaunNUM = document.getElementById("total")
	let caunt = 0
	let i = 1;
	let image = document.getElementById("image");
	var imgs = new Array('img/slider/pepper.jpg', 'img/slider/food-12.jpg', 'img/slider/olive-oil.jpg', `img/slider/paprika.jpg`);
	...
	btnOnl.onclick = () => {
		...
		imgsrc()
		numCaun.innerHTML = caunt++
	if (caunt == 4) {
		caunt= 0
	}
	}
	let imageTwo = document.getElementById("sliderPic");

	imageTwo.onclick = () => {
		imgsrc()
	

		numCaunNUM.innerHTML = caunt--
	}
